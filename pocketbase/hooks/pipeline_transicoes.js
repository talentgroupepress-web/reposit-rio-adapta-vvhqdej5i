...
onRecordValidate((e) => {
  ...
  // 4. oportunidade exige demanda concreta + avanco
  ...
  // 5. proposta exige evidencia de proposta registrada
  ...
  // 7. vaga_aberta -> ganho exige evidencia de fechamento (CA-1-10)
  ...
  // 8. Estados terminais exigem motivo (e evidencia p/ ganho)
  ...
  // 9. Nao retroceder de estado terminal
  ...
  // 10. Conquista: 1a vaga/demanda valida -> data_conquista
  if (
    dataConquista &&
    dataConquista.trim() !== '' &&
  ...
  // 11. tipo_conquista nao pode ser inventado sem evidencia
